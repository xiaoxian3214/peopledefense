          ...
          <div class="grid-content bg-purple">
            ...
            <div class="formBox">
              <el-select
                ...
                placeholder="请选择行政区"
                :disabled="$store.state.roleIdList.length == 1 && $store.state.roleIdList.includes(2)"
              >
                <el-option
      ...
      <el-row type="flex">
        ...
        <el-col :span="5" :offset="2">
          <div class="grid-content bg-purple">
            ...
            <div class="formBox">
              <el-select
                v-model="addform.protectionSchemePreparationStatus"
                placeholder="请选择情况"
              >
                <el-option
              ...
              <!-- {{PreparationOfProtectionSchemesList}} -->
            </div>
          </div>
        </el-col>
        <el-col :span="5" :offset="2">
          <div class="grid-content bg-purple">
            <div class="formLable longleabl">系统是否接入人防指挥平台:</div>
            <div class="formBox">
              <el-select
...
export default {
  ...
  mounted() {
    ...
    if (this.$store.state.roleIdList.includes(2)) {
  ...
  methods: {
    ...
    confirm() {
      ...
      this.isloading = true;
      this.$api.economicadd(data).then((res) => {
