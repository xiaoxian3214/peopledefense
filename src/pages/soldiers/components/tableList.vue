      ...
      >
        <template slot-scope="scope">
          <el-button type="text" class="optionBtnDel" @click="delet(scope.row)"
             v-if="$store.state.ifBut" >删除</el-button
          >
          <el-divider direction="vertical" v-if="$store.state.ifBut"></el-divider>
          <el-button type="text" class="optionBtn" @click="edit(scope.row)" v-if="$store.state.ifBut"
            >编辑</el-button
          >
          <el-divider direction="vertical" v-if="$store.state.ifBut"></el-divider>
...
export default {
  ...
  methods: {
    ...
    edit(val) {
      this.$router.push("/pages/soldiers/edit?id=" + val.id);
    },
    detail(val) {
      this.$router.push(
        "/pages/soldiers/detail?id=" + val.id
      );
    },
  },
};
