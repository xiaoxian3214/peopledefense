...
export default {
  ...
  methods: {
    ...
    playersdetail(id) {
      this.$api.playersSourcedetail({ id }).then((res) => {
        if (res.code == 200) {
    ...
    confirm() {
      ...
      this.isloading = true;
      this.$api.playersSourceupdate(data).then((res) => {
