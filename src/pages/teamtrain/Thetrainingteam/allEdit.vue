<template>
  <div>
    <detail-header title="编辑人员" :breadcrumbList="breadcrumbList"></detail-header>
    <div class="fromHeader" @click="$router.push('/pages/teamtrain/Thetrainingteam/list')">
    ...
    <div class="fromtableListBox">
      ...
      <el-row type="flex">
        <el-col :span="11">
          <div class="formLable"><span class="formBj" v-if="$store.state.roleIdList.includes(4)">*</span>选择训练人员:</div>
          <div class="formBox">
            <el-transfer
          ...
          <el-row>
            <el-col :span="24">
              <div class="grid-content bg-purple">
                ...
                <div class="formBox">
                  <el-input oninput="value=value.replace(/[^\d]/g,'')" v-model="addform.numberPerson" placeholder="请输入训练人数" class="formInp" type="text" disabled></el-input>
                </div></div
            ></el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <div class="grid-content bg-purple">
                <div class="formLable"><span class="formBj" v-if="$store.state.roleIdList.includes(4)">*</span>队长(视频采集人员):</div>
                <div class="formBox">
                  <el-select v-model="addform.gatherPersonId" placeholder="请选择采集人员">
                    <el-option v-for="item in personnelList2Value" :key="item.id" :label="item.name" :value="item.id"> </el-option>
                  </el-select>
                </div>
              </div>
            </el-col>
...
export default {
  ...
  methods: {
    ...
    professionalTeamIchage() {
      this.$api.playersallList({ professionalTeamId: this.addform.professionalTeamId }).then((res) => {
        if (res.code == 200) {
