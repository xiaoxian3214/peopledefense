<template>
  <div class="table-box">
    ...
    >
      ...
      <el-table-column
        label="专业队数量"
        prop="professionalTeamNum"
        :show-overflow-tooltip="true"
        align="center"
      ></el-table-column>
      <el-table-column
        label="本科以上人数"
        prop="regularCollegeCourseNum"
        :show-overflow-tooltip="true"
        align="center"
      ></el-table-column>
      <el-table-column
        label="大专人数"
        prop="juniorCollegePersonNum"
        :show-overflow-tooltip="true"
        align="center"
      ></el-table-column>
      <el-table-column
        label="高中人数"
        prop="juniorCollegeUnderPersonNum"
        :show-overflow-tooltip="true"
        align="center"
      ></el-table-column>
      <el-table-column
        label="初中人数"
        prop="masterDegreeOrBovePersonNum"
        :show-overflow-tooltip="true"
        align="center"
      ></el-table-column>
      <el-table-column
        label="专业队组建比例"
        prop="professionalTeamBuildRatio"
        :show-overflow-tooltip="true"
        align="center"
      ></el-table-column>
    </el-table>
