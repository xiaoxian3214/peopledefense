<template>
  <div>
    <detail-header title="新增队员" :breadcrumbList="breadcrumbList"></detail-header>
    <div
      class="fromHeader"
      @click="
        () => {
...
export default {
  ...
  mounted() {
    ...
    if (this.$route.query.data) {
      ...
      this.addform.professionalTeamId = data.professionalTeamNameId;
    }
  },
  methods: {
    Teamchage(item1) {
    ...
    confirm() {
      ...
      this.isloading = true;
      this.$api.playersadd(data).then((res) => {
